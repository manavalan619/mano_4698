...
DESKTOPCODE='../../../application/client/desktop/mano_4698'
DESKTOPIMAGENAME='geppettotest/mano_4698-desktop:1.0'
...
helm install --name mano_4698 ./helm
if [ $? -eq 0 ]; then
